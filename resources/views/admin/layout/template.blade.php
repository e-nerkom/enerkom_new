...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="{{url('admin')}}" class="logo">
      ...
      <span class="logo-mini"><b>E</b>KM</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>E</b>-nerkom</span>
    </a>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2018 <a href="https://e-nerkom.com/" target="__blank">PT. Energi Jaring Komunikasi</a>.</strong> All rights reserved.
  </footer>
